...
| **4** | Coach subagent as hub-and-spoke coordinator over verifier + examiner + progress-tracking MCP server | done |
| **5** | Authoring commands (`/new-lesson`, `/new-question`) + full content build-out for all 37 lessons | done |
